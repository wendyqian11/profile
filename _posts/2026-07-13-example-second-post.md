...
You can safely **delete this file** once you're comfortable, or keep editing it
as a playground for trying out Markdown.

> Tip: text starting with `>` becomes a nice quote block like this one.
